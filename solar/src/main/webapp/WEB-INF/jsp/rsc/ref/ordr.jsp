...
<div class="row" id="senseOrdrRef">
		<div id="senseOrdrRefBody" class="card card-pricing card-primary card-white card-outline col-3" style="margin-left: 50px;margin-right: 30px;margin-top: 150px;padding-left: 40px;margin-bottom: 300px; height:350px">
		<div class="card-body" >
  ...
  <div style="margin-bottom: 20px;"><label>발주업체</label> <input type="text" id="co" name="co"><button type="button" id="coSearchBtn">🔍</button></div>
   <div style="margin-bottom: 20px;"><label>자재&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</label> <input type="text" id="rsc" name="rsc"><button type="button" id="rscSearchBtn">🔍</button></div>
...
//
  ...
  $('#senseOrdrRef').resize(function(){
		if($('#senseOrdrRef').width()<1780){
			$('#senseOrdrRefBody').css('paddingLeft','15px');
		}else{
			$('#senseOrdrRefBody').css('paddingLeft','40px');
		}
	})
</script>
