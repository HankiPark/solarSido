...
public class Prcs2Scheduler {
	  ...
	  // System.out.println(plist.get(i).getPrdtFg().equals("P") && plist.get(i).getPrcsFrTm()==null);
	  ...
	  else if(plist.get(i).getPrdtFg().equals("P1") && plist.get(i).getPrcsFrTm()==null  && elist2.size()!=0) { 
		  EqmAble eq = new EqmAble();
		  plist.get(i).setPrcsFrTm(java.sql.Timestamp.valueOf(LocalDateTime.now()));
	  ...
	  else if(plist.get(i).getPrdtFg().equals("P2") && plist.get(i).getPrcsFrTm()==null  && elist3.size()!=0) { 
		  EqmAble eq = new EqmAble();
		  plist.get(i).setPrcsFrTm(java.sql.Timestamp.valueOf(LocalDateTime.now()));
	  ...
	  else if(plist.get(i).getPrdtFg().equals("P3") && plist.get(i).getPrcsFrTm()==null  && elist4.size()!=0) { 
		  EqmAble eq = new EqmAble();
		  plist.get(i).setPrcsFrTm(java.sql.Timestamp.valueOf(LocalDateTime.now()));
	  ...
	  { 
		  ...
		  count++;
	  }else if(plist.get(i).getPrdtFg().equals("C")){
		  count++;
