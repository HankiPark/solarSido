...
public class EqmController {
	...
	// 비가동그래프 페이지
	@GetMapping("/eqm/ref/uograph")
	public String uoGraph() {
		return "eqm/ref/uograph";
	}
	...
	public String uoGraphData(@RequestBody Map<String,String> map, Model model) {
		...
		map2.put("eqmCds", eqmCds);
		model.addAttribute("graphData",unopMapper.uoGraph(map2));
		return "jsonView";
	}
}
